...
const UpdateProfileDialog = ({ open, setOpen }) => {
    ...
    return (
        <Dialog open={open} onOpenChange={setOpen}>
            <DialogContent className="sm:max-w-xl max-h-[90vh] overflow-y-auto p-6" onInteractOutside={() => setOpen(false)}>
                <DialogHeader className="pb-2 border-b border-slate-100">
                    <DialogTitle className="text-xl font-bold text-slate-900">Edit Student Profile</DialogTitle>
                    <p className="text-xs text-slate-500">Update your academic credentials, skills, and contact information</p>
                </DialogHeader>
                ...
                <div className="flex gap-2 p-1 bg-slate-100 rounded-xl my-2 text-xs font-medium">
                    <button
                        ...
                        className={`flex-1 py-1.5 rounded-lg flex items-center justify-center gap-1.5 transition-all ${activeTab === "basic" ? "bg-white text-indigo-600 shadow-xs font-semibold" : "text-slate-600 hover:text-slate-900"}`}
                    >
                    ...
                    <button
                        ...
                        className={`flex-1 py-1.5 rounded-lg flex items-center justify-center gap-1.5 transition-all ${activeTab === "academic" ? "bg-white text-indigo-600 shadow-xs font-semibold" : "text-slate-600 hover:text-slate-900"}`}
                    >
                        <GraduationCap className="w-3.5 h-3.5" /> Academics & Skills
                    </button>
                    <button
                        type="button"
                        onClick={() => setActiveTab("links")}
                        className={`flex-1 py-1.5 rounded-lg flex items-center justify-center gap-1.5 transition-all ${activeTab === "links" ? "bg-white text-indigo-600 shadow-xs font-semibold" : "text-slate-600 hover:text-slate-900"}`}
                    >
                        <LinkIcon className="w-3.5 h-3.5" /> Links & Resume
                    </button>
                </div>
                ...
                <form onSubmit={submitHandler} className="space-y-4 pt-1">
                        ...
                        <div className="space-y-3 animate-in fade-in-50 duration-200">
                            ...
                            <div>
                                ...
                                <textarea 
                                    ...
                                    value={input.bio} 
                                    onChange={changeEventHandler} 
                                    className="w-full mt-1 p-2 text-xs border border-slate-200 rounded-lg focus:outline-none focus:ring-1 focus:ring-indigo-500/30 text-slate-800"
                    ...
                    {activeTab === "academic" && (
                        <div className="space-y-3 animate-in fade-in-50 duration-200">
                            <div>
                                <Label htmlFor="college" className="text-xs font-semibold text-slate-700">College / University</Label>
                                <Input 
                                    id="college" 
                                    name="college" 
                                    type="text" 
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                                <div>
                                    <Label htmlFor="degree" className="text-xs font-semibold text-slate-700">Degree & Branch</Label>
                                    <Input 
                                        id="degree" 
                                        name="degree" 
                                        type="text" 
                                ...
                                <div>
                                    <Label htmlFor="graduationYear" className="text-xs font-semibold text-slate-700">Graduation Year</Label>
                                    <Input 
                                        id="graduationYear" 
                                        name="graduationYear" 
                                        type="text" 
                            ...
                            <div>
                                <Label htmlFor="cgpa" className="text-xs font-semibold text-slate-700">CGPA or Percentage</Label>
                                <Input 
                                    id="cgpa" 
                                    name="cgpa" 
                                    type="text" 
                            ...
                            <div>
                                <Label htmlFor="skills" className="text-xs font-semibold text-slate-700">Technical Skills (Comma separated)</Label>
                                <Input 
                                    id="skills" 
                                    name="skills" 
                                    type="text" 
                    ...
                    {activeTab === "links" && (
                        <div className="space-y-3 animate-in fade-in-50 duration-200">
                            ...
                            <div className="pt-2 border-t border-slate-100">
                                <Label htmlFor="file" className="text-xs font-semibold text-slate-700 block mb-1">Resume Document (PDF)</Label>
                                <div className="border border-dashed border-slate-200 rounded-xl p-3 bg-slate-50/60">
                                    ...
                                    {input.resumeOriginalName && (
                                        <p className="text-xs text-indigo-600 mt-2 flex items-center gap-1.5 font-medium">
                                            ...
                                            Current: {input.resumeOriginalName}
                                        </p>
                                    )}
                                </div>
                            </div>
                    ...
                    <DialogFooter className="pt-3 border-t border-slate-100 flex items-center justify-between">
                        ...
                        <Button 
                            type="submit" 
                            disabled={loading}
                            className="bg-indigo-600 hover:bg-indigo-700 text-white text-xs font-medium px-5 h-9 rounded-xl shadow-xs"
                        >
                            {loading ? (
                                <>
